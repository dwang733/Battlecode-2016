...
//                        bugPathing(targetLoc);
                ...
                while (buildDisruptiveScout) {
                    ...
                    if (rc.getRoundNum() < DISRUPTIVE_SCOUT_ROUND_LIMIT && leaderArchonStatus != ArchonStatus.CRAMPED &&
...
//                }
    ...
    static void soldierRush() throws GameActionException {
        ...
        if (rc.senseNearbyBullets(-1).length > 0 || leaderArchonStatus == ArchonStatus.CRAMPED ||
            ...
            SOLDIER_COOLDOWN = 10;
            SOLDIER_THRESHOLD = RobotType.SOLDIER.bulletCost * 1.25f;
        }
        else {
